...
describe("UUID Value Object Unit Tests", () => {
	...
	it("should throw an error if the UUID is invalid", () => {
		expect(() => Uuid.create("invalid-uuid")).toThrowError(
	...
	it("should be a valid UUID", () => {
		...
		const uuid2 = Uuid.create("a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11");
	...
	it("should be the same UUID value object", () => {
		const uuid1 = Uuid.create("a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11");
		const uuid2 = Uuid.create("a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11");
